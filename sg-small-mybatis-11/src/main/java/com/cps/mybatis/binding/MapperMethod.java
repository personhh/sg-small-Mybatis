...
public class MapperMethod {
    ...
    public Object execute(SqlSession sqlSession, Object[] args) {
        ...
        switch (command.getType()) {
            case INSERT:
                ...
                result = sqlSession.insert(command.getName(), param1);
                break;
            case DELETE:
                Object param2 = method.convertArgsToSqlCommandParam(args);
                result = sqlSession.delete(command.getName(), param2);
                break;
            case UPDATE:
                Object param3 = method.convertArgsToSqlCommandParam(args);
                result = sqlSession.update(command.getName(), param3);
                break;
            case SELECT:
    ...
    * */
    ...
    public static class MethodSignature{
        private final SortedMap<Integer, String> params;//参数集,SortedMap主要是保证了key值的有序性（升序）
        ...
        public MethodSignature(Configuration configuration, Method method) {
            ...
            this.params = Collections.unmodifiableSortedMap(getParams(method));//unmodifiableSortedMap返回指定有序映射的不可修改视图
        }
